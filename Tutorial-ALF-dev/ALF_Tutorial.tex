...
% \textbf{\textcolor{red}{Notice}} that the latest stable release of ALF is ALF 2.5 -- the correspondent tutorial can be found at \href{https://git.physik.uni-wuerzburg.de/ALF/ALF_Tutorial/-/tree/master/Tutorial-ALF-2.5}{https://git.physik.uni-wuerzburg.de/ALF/ALF\_Tutorial/-/tree/master/Tutorial-ALF-2.5} .
% %%%%%%%%%%%%%%%                                            %%%%%%%%%%%%%%%
% %
...
Additionally, you will need the dependencies of \href{https://git.physik.uni-wuerzburg.de/ALF/ALF/-/tree/\ALFbranch}{ALF} itself:
\begin{itemize}
   \item make
...
The ALF dependencies can be installed in a Debian-based Linux (Debian/Ubuntu/Linux Mint) via
