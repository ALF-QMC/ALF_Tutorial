...
!> of Nematic_Dirac by the Hamiltonian name, populating the subroutines below as needed
...
!--------------------------------------------------------------------
    ...
    submodule (Hamiltonian_main) ham_Nematic_Dirac_smod
      ...
      Type (Unit_cell),     target :: Latt_unit, latt_unit_ising
...
!-------------------------------------------------------------------
    ...
    end submodule ham_Nematic_Dirac_smod
