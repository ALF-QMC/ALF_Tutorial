...
!         NAMELIST /VAR_Hubbard/  ham_T, ham_chem, ham_U, Dtau, Beta
          NAMELIST /VAR_Hubbard/  ham_T, Ham_Ty, ham_chem, ham_U, Dtau, Beta
!!!!!!
...
!!!!!! Modifications for Exercise 2 (b)
          !Allocate ( Obs_eq(4) )
          Allocate ( Obs_eq(5) )
!!!!!!    
...
!!!!!! Modifications for Exercise 2 (b)
                   Obs_eq(5)%Obs_Latt(imj,1,no_I,no_J) =  Obs_eq(5)%Obs_Latt(imj,1,no_I,no_J) + &
                        ...
                        &    2.d0*GRC(I1,J1,1) * GR(I1,J1,2) +  2.d0*GRC(I1,J1,2) * GR(I1,J1,1)    ) *  ZP*ZS/3.d0
!!!!!!                       
                enddo
