...
!!!! Modifications for Exercise 3
             Ix = Latt%nnlist(I,1,0)
             Obs_eq(6)%Obs_Latt0(1) = Obs_eq(6)%Obs_Latt0(1) + (GRC(I,Ix,1) + GRC(I,Ix,2) + &
                                                             &  GRC(Ix,I,1) + GRC(Ix,I,2) ) *  ZP*ZS
!!!! End modifications
          enddo
...
!!!! Modifications for Exercise 3
             Ix = Latt%nnlist(I,1,0)
             Obs_tau(6)%Obs_Latt0(1) = Obs_tau(6)%Obs_Latt0(1) - &
                  &                   (GTT(I,Ix,1) + GTT(I,Ix,2) + GTT(Ix,I,1) + GTT(Ix,I,2))  *  ZP*ZS
!!!! End modifications
          enddo
