...
\newcommand{\ALFver}{2.2}          %{2.2}{dev.} version of ALF the tutorial uses
\newcommand{\ALFbranch}{ALF-2.2}   %{ALF-2.2}{master} corresponding ALF branch
\newcommand{\pyALFver}{2.2}        %{2.2}{dev.} version of pyALF the tutorial uses
\newcommand{\pyALFbranch}{ALF-2.2} %{ALF-2.2}{master} corresponding pyALF branch
