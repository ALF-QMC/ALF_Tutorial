...
!!!!! Modifications for Exercise 3
          NAMELIST /VAR_tV/  ham_T, ham_chem, ham_Vint, Dtau, Beta
!!!!!           
          ...
          elseif  ( Model == "Hubbard_SU2_Ising" ) then
             ...
             Endif
!!!!! Modifications for Exercise 3
          elseif  ( Model == "t_V" ) then
             N_FL = 1
             N_SUN = 1
             If (L2  /=  1 ) then
                Write(6,*) "t_V model is implemented only for L2 = 1"
                Stop
             Endif
!!!!!             
          else
          ...
          If (Irank == 0 ) then
             ...
             If (Model == "t_V"                                    )  Read(5,NML=VAR_tV)
             CLOSE(5)
